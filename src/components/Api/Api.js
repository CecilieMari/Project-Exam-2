...
export const venuesAPI = {
  ...
  create: (venueData, accessToken) =>
    apiCall("/holidaze/venues", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
  ...
  update: (id, venueData, accessToken) =>
    apiCall(`/holidaze/venues/${id}`, {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
...
export const bookingsAPI = {
  ...
  getById: (id, accessToken) =>
    apiCall(`/holidaze/bookings/${id}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
    }),
  update: (id, bookingData, accessToken) =>
    apiCall(`/holidaze/bookings/${id}`, {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${accessToken}`,
